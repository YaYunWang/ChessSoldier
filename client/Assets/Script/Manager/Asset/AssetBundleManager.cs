...
public class AssetBundleManager : ManagerTemplate<AssetBundleManager>
{
...
#endif
        {
            m_assetBundleManifest = LoadAsset(ResourceUtil.GetPlatformName(), "AssetBundleManifest", typeof(AssetBundleManifest)) as AssetBundleManifest;
    ...
    public static Object LoadAsset(string assetBundleName, string assetName, System.Type type)
    {
...
#endif
        {
            ...
            return loadedBundle.assetBundle.LoadAsset(assetName, type);
        }
    }
