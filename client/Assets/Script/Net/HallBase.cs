...
namespace KBEngine
{
	...
	{
		public EntityBaseMailbox_HallBase baseMailbox = null;
		public EntityCellMailbox_HallBase cellMailbox = null;



		public override void onGetBase()
		{
			baseMailbox = new EntityBaseMailbox_HallBase();
			baseMailbox.id = id;
		...
		{
			cellMailbox = new EntityCellMailbox_HallBase();
			cellMailbox.id = id;
