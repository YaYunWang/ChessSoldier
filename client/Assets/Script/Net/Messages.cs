...
namespace KBEngine
{
	...
	public class Message_Base_forwardEntityMessageToCellappFromClient : Message
	{

		public Message_Base_forwardEntityMessageToCellappFromClient(MessageID msgid, string msgname, Int16 length, sbyte argstype, List<Byte> msgargtypes):
			base(msgid, msgname, length, argstype, msgargtypes)
		{
	...
	public class Message_Base_onRemoteMethodCall : Message
	{

		public Message_Base_onRemoteMethodCall(MessageID msgid, string msgname, Int16 length, sbyte argstype, List<Byte> msgargtypes):
			base(msgid, msgname, length, argstype, msgargtypes)
		{
	...
	public class Messages
	{
		...
		public static bool init()
		{
			...
			Messages.messages["Base_forwardEntityMessageToCellappFromClient"] = new Message_Base_forwardEntityMessageToCellappFromClient(57, "Base_forwardEntityMessageToCellappFromClient", -1, -1, new List<Byte>());
			Messages.baseappMessages[57] = Messages.messages["Base_forwardEntityMessageToCellappFromClient"];
			...
			Messages.messages["Base_onRemoteMethodCall"] = new Message_Base_onRemoteMethodCall(301, "Base_onRemoteMethodCall", -1, -1, new List<Byte>());
			Messages.baseappMessages[301] = Messages.messages["Base_onRemoteMethodCall"];
