...
#include "GameCG.cginc"
	...
	SurfaceOutput_CharacterVeryHighQuality o = (SurfaceOutput_CharacterVeryHighQuality)0;
#else
	SurfaceOutput_CharacterVeryHighQuality o;
#endif
	o.Albedo = 0.0;
	o.Emission = 0.0;
	o.Specular = 0.0;
...
#endif
	LightingCharacterVeryHighQuality_GI(o, giInput, gi);
	...
	c += LightingCharacterVeryHighQuality(o, worldViewDir, gi);
...
#include "GameCG.cginc"
	...
	fixed3 worldViewDir = normalize(UnityWorldSpaceViewDir(worldPos));
#ifdef UNITY_COMPILER_HLSL
	SurfaceOutput_CharacterLowQuality o = (SurfaceOutput_CharacterLowQuality)0;
#else
	SurfaceOutput_CharacterLowQuality o;
#endif
	o.Albedo = 0.0;
	o.Emission = 0.0;
	o.Alpha = 0.0;
	...
	giInput.probePosition[1] = unity_SpecCube1_ProbePosition;
#endif
	LightingCharacterLowQuality_GI(o, giInput, gi);
	...
	// realtime lighting: call lighting function
	c += LightingCharacterLowQuality(o, worldViewDir, gi);
	UNITY_APPLY_FOG(IN.fogCoord, c); // apply fog
	return c;
	}
