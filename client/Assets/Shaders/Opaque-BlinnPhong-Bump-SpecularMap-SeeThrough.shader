Shader "Demo03/Opaque/Alternative/See Through/BlinnPhong (Bump Map + Specular Map)" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf CustomBlinnPhong fullforwardshadows noforwardadd alpha:fade
...
//			float2 uv_SpecularMap;
	...
	SubShader {
		...
		#include "GameCG.cginc"
		// Physically based Standard lighting model, and enable shadows on all light types
		#pragma surface surf Lambert fullforwardshadows noforwardadd alpha:fade
