...
Shader "Demo03/Particle/Transparent/Alpha Blended (SR2)" {
	Properties{
		_MainTex("Base layer (RGB)", 2D) = "white" {}
		_Scroll("Base layer scroll speed (Vector2) X Y", Vector) = (1,0,0,0)
		_Rotation("Base layer rotation (CenterX, CenterX, Start, Speed)", Vector) = (0.5, 0.5, 0, 1)

		_DetailTex("2nd layer (RGB)", 2D) = "white" {}
		_Scroll2("2nd layer scroll speed (Vector2) X Y", Vector) = (1,0,0,0)
		_Rotation2("2nd layer rotation (CenterX, CenterX, Start, Speed)", Vector) = (0.5, 0.5, 0, 1)
