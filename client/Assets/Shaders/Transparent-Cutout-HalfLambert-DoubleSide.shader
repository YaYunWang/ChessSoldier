Shader "Demo03/Transparent (Cutout)/Half Lambert (Double Side)" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf HalfLambert alphatest:_Cutoff addshadow noforwardadd
		...
		// Physically based Standard lighting model, and enable shadows on all light types
		#pragma surface surf HalfLambert alphatest:_Cutoff fullforwardshadows
