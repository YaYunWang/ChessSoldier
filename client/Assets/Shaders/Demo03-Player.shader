...
#include "GameCG.cginc"
	...
	SurfaceOutput_CharacterModelShow o = (SurfaceOutput_CharacterModelShow)0;
#else
	SurfaceOutput_CharacterModelShow o;
#endif
	o.Albedo = 0.0;
	o.Emission = 0.0;
	o.Specular = 0.0;
...
#endif
	LightingCharacterModelShow_GI(o, giInput, gi);
	...
	c += LightingCharacterModelShow(o, worldViewDir, gi);
	c.rgb += o.Emission;
